...
////        $Yaf_Request = new ;
    ...
    static function getPairParam( &$request, ParamRule &$rule) {
...
//        }
    ...
    static function paramsFromRequest( &$request, $required, $optional) {
        $rules = array();
    ...
    static function paramsFromRequestAndRules( &$request, $rules,$throw_code=-100) {
        $params = array();
    ...
    static function pairParamsFromRequestAndRules( &$request, $rules) {
        $params = array();
        foreach ($rules as $name => $rule) {
    ...
    static function getParam( &$request, ParamRule &$rule,$throw_code=-100) {
