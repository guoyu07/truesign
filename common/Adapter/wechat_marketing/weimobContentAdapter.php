...
class weimobContentAdapter extends DbLibraryAdapter
{
    ...
    public function tableInit()
    {
        return Field::start()
            ...
            ->def('is_awards')->map('is_awards')->int()->desc('是否允许打赏')->widgetType('radio',array('',(array('不可以','可以')))) //0->不可以，1->可以
            ...
            ->def('is_comment')->map('is_comment')->int()->desc('是否允许评论')->widgetType('radio',array('',(array('不可以','可以')))) //0->不可以，1->可以
            ...
            ->def('verified')->map('verified')->int()->desc('审核标志')->widgetType('radio',array('',(array('驳回','通过'))))
