 ...
 */
use Truesign\Service\Techies\ImagesService;
class ImagesController extends AppBaseController
{
	 ...
	 * 获取表规则
	 */
    public function descImagesAction()
    {
        $params = $this->getParams(array(),array('rules'));
        $doService = new ImagesService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('初始图片表化信息成功');
    ...
    public function getImagesAction()
    {
        ...
        $doService = new ImagesService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('获取图片表信息成功');
    ...
    public function UpdateImagesAction(){
        ...
        $doService = new ImagesService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('更新图片表信息成功');
     ...
     * 批量删除
     */
    public function GroupDelImagesAction()
    {
        ...
        $doService = new ImagesService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('批量删除图片表成功');
