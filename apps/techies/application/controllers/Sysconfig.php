 ...
 */
use Truesign\Service\Techies\SysconfigService;
class SysconfigController extends AppBaseController
{
    /**
     * 控制器初始化
     * 该函数会在控制器对象实例化之后被调用。
	 ...
	 * 获取表规则
	 */
    public function descSysconfigAction()
    {
        $params = $this->getParams(array(),array('rules'));
        $doService = new SysconfigService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('初始系统/配置表化信息成功');
     ...
     *
     */
    public function getSysconfigAction()
    {
        ...
        $doService = new SysconfigService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('获取系统/配置表信息成功');
    ...
    /*
         ...
         *
         */
    public function UpdateSysconfigAction(){
        $params = $_POST;
        $condition['id'] = $params['document_id'];
        $doService = new SysconfigService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('更新系统/配置表信息成功');
     ...
     * 批量删除
     */
    public function GroupDelSysconfigAction()
    {
        ...
        $doService = new SysconfigService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('批量删除系统/配置表成功');
