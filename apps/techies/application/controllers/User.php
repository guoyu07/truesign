 ...
 */
use Truesign\Service\Techies\UserService;
class UserController extends AppBaseController
{
	 ...
	 * 获取表规则
	 */
    public function descUserAction()
    {
        $params = $this->getParams(array(),array('rules'));
        $doService = new UserService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('初始用户表化信息成功');
    ...
    public function getUserAction()
    {
        ...
        $doService = new UserService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('获取用户表信息成功');
    ...
    public function UpdateUserAction(){
        ...
        $doService = new UserService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('更新用户表信息成功');
     ...
     * 批量删除
     */
    public function GroupDelUserAction()
    {
        ...
        $doService = new UserService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('批量删除用户表成功');
