...
/**
 * Create by Smartisan
 * @name PaylogsController
 * @author placeless
 * @desc 默认控制器
 * @see http://www.php.net/manual/en/class.yaf-controller-abstract.php
 */
use Truesign\Service\Techies\PaylogsService;
class PaylogsController extends AppBaseController
{
    /**
     * 控制器初始化
     * 该函数会在控制器对象实例化之后被调用。
	 ...
	 * 获取表规则
	 */
    public function descPaylogsAction()
    {
        $params = $this->getParams(array(),array('rules'));
        $doService = new PaylogsService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('初始支付表化信息成功');
     ...
     *
     */
    public function getPaylogsAction()
    {
        ...
        $doService = new PaylogsService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('获取支付表信息成功');
    ...
    /*
         ...
         *
         */
    public function UpdatePaylogsAction(){
        $params = $_POST;
        $condition['id'] = $params['document_id'];
        $doService = new PaylogsService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('更新支付表信息成功');
     ...
     * 批量删除
     */
    public function GroupDelPaylogsAction()
    {
        ...
        $doService = new PaylogsService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('批量删除支付表成功');
