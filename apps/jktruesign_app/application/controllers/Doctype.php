...
/**
 * Create by Smartisan
 * @name DoctypeController
 * @author placeless
 * @desc 默认控制器
 * @see http://www.php.net/manual/en/class.yaf-controller-abstract.php
 */
use Truesign\Service\Jktruesign_app\DoctypeService;
class DoctypeController extends AppBaseController
{
	 ...
	 * 获取表规则
	 */
    public function descDoctypeAction()
    {
        $params = $this->getParams(array(),array('rules'));
        $doService = new DoctypeService();
    ...
    /*
         ...
         *
         */
    public function UpdateDoctypeAction(){
        $params = $_POST;
     ...
     * 批量删除
     */
    public function GroupDelDoctypeAction()
    {
