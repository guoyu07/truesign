...
/**
 * Create by Smartisan
 * @name DochandlelogController
 * @author placeless
 * @desc 默认控制器
 * @see http://www.php.net/manual/en/class.yaf-controller-abstract.php
 */
use Truesign\Service\Jktruesign_app\DochandlelogService;
class DochandlelogController extends AppBaseController
{
    /**
     * 控制器初始化
     * 该函数会在控制器对象实例化之后被调用。
	 ...
	 * 获取表规则
	 */
    public function descDochandlelogAction()
    {
        $params = $this->getParams(array(),array('rules'));
        $doService = new DochandlelogService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('初始文档类型化信息成功');
     ...
     *
     */
    public function getDochandlelogAction()
    {
        ...
        $doService = new DochandlelogService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('获取文档类型信息成功');
    ...
    /*
         ...
         *
         */
    public function UpdateDochandlelogAction(){
        $params = $_POST;
        $condition['id'] = $params['document_id'];
        $doService = new DochandlelogService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('更新文档类型信息成功');
     ...
     * 批量删除
     */
    public function GroupDelDochandlelogAction()
    {
        ...
        $doService = new DochandlelogService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('批量删除文档类型成功');
