 ...
 */
use Truesign\Service\Demo\UsersService;
class UsersController extends AppBaseController
{
	 ...
	 * 获取表规则
	 */
    public function descUsersAction()
    {
        $params = $this->getParams(array(),array('rules'));
        $doService = new UsersService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('初始用户信息化信息成功');
    ...
    public function getUsersAction()
    {
        ...
        $doService = new UsersService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('获取用户信息信息成功');
    ...
    public function UpdateUsersAction(){
        ...
        $doService = new UsersService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('更新用户信息信息成功');
     ...
     * 批量删除
     */
    public function GroupDelUsersAction()
    {
        ...
        $doService = new UsersService();
        $response = \Royal\Prof\TrueSignConst::SUCCESS('批量删除用户信息成功');
