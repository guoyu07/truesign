<template>
    <div class="root_home" style="background-color: translate" >
        <!--<div class="word_show">-->
            <!--<h1>数据</h1>-->
            <!--<h1>可视</h1>-->
            <!--<h1>可控</h1>-->
...
<style lang="stylus" rel="stylesheet/stylus">
    .root_home{
        ...
        height 100%
        text-align center
        background-color rgba(247, 250, 255, 0.53)

    }
    .word_show{
        width: 50%;height: 50%;margin: 10% auto;min-width: 500px;min-height: 300px
        letter-spacing 5px
