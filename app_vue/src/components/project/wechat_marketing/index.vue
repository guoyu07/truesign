<template>
    <div class="top_router_view" style="background-color: #dfe4db;text-align: center;overflow: hidden;" >
        <p class="top_router_tip" style="opacity: 0.2">wechat_marketing</p>

        <navmenu :logo="logo" :menulist="menulist"></navmenu>


        <div style="min-width: 1200px;width: 800px;background-color: lightgrey;height: 100%;margin: 0 auto;padding-top: 70px">
