...
<script>
    ...
    export default {
        data(){
            return {
                ...
                info_transfer_action: {
                    add: 'App/Desc?app=server_app',
                    get: 'App/Get?app=server_app',
                    update: 'App/Update?app=server_app',
                    groupdel: false
                },
        ...
        created(){
            var vm = this
            this.report_api = this.socket_server_store.apihost + 'App/'
            this.$root.eventHub.$emit('init_navmenu', 'ssm_app')
